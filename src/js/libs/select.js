...
class SelectConstructor {
	...
	selectInit(originalSelect, index) {
		...
		selectItem.insertAdjacentHTML('beforeend', `<div class="${this.selectClasses.classSelectBody} _icon-arrow-bottom"><div hidden class="${this.selectClasses.classSelectOptions}"></div></div>`);
